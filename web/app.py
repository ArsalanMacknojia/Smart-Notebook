...
def seed_db():
    ...
    db.session.add(User(username="ArsalanMacknojia", first_name="Arsalan", last_name="Macknojia", email="arsalan@gmail.com", phone_number="7781111111", postal_code="V3E3B5", password="$2b$12$ppAg.mOnlIo15d0m7gPYr.1LZaUvuO29JVVBkv6bkQzQz6zK.f66y", user_image="fbe019790fa740498056398282b88920.jpg"))
    db.session.commit()
